    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      fetch(action, {
        ...
        .then(function () {
          ...
          successEl.textContent = contactForm.dataset.successMessage || 'Thank you! Your message has been sent.';
        ...
        .catch(function () {
          ...
          errorEl.textContent = contactForm.dataset.errorMessage || 'Something went wrong. Please try again.';
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Liel gift boxes משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '9d8f64ff-f9e7-4475-b23b-0e5b33fbe363',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '9d8f64ff-f9e7-4475-b23b-0e5b33fbe363';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '9d8f64ff-f9e7-4475-b23b-0e5b33fbe363';
